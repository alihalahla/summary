...
let ReachabilityStatusChangedNotification
...
public class Reach {
        ...
        ReachabilityStatus {
            ...
            guard let
                ...
                withUnsafePointer(to: &zeroAddress, {
                    ...
                    sockaddr.self, capacity: 1) { SCNetworkReachabilityCreateWithAddress(nil, $0)
                    }
                }) else {
                    return .unknown
            }
            ...
            return
                ReachabilityStatus(reachabilityFlags:
                    flags)
    }
    ...
    func monitorReachabilityChanges() {
        let host = "google.com"
        var context =
            SCNetworkReachabilityContext(version: 0,
                                         info: nil, retain: nil, release: nil,
                                         copyDescription: nil)
        let reachability =
        ...
        SCNetworkReachabilityScheduleWithRunLoop(
            reachability, CFRunLoopGetMain(),
            RunLoop.Mode.common as CFString)
    }
    
}
extension ReachabilityStatus {
    init(reachabilityFlags flags:
        SCNetworkReachabilityFlags) {
